...
.dlls,em4f .dlls: SlaveController.pem4f

-include package/cfg/SlaveController_pem4f.mak
-include package/cfg/SlaveController_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/SlaveController_pem4f.dep
endif
SlaveController.pem4f: package/cfg/SlaveController_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
SlaveController.pem4f package/cfg/SlaveController_pem4f.c: .libraries,em4f
endif

package/cfg/SlaveController_pem4f.c package/cfg/SlaveController_pem4f.h package/cfg/SlaveController_pem4f.xdl: override _PROG_NAME := SlaveController.xem4f
package/cfg/SlaveController_pem4f.c: package/cfg/SlaveController_pem4f.cfg
package/cfg/SlaveController_pem4f.xdc.inc: package/cfg/SlaveController_pem4f.xdl
package/cfg/SlaveController_pem4f.xdl package/cfg/SlaveController_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/SlaveController_pem4f.cfg
	-$(RM) package/cfg/SlaveController_pem4f.dep
	-$(RM) package/cfg/SlaveController_pem4f.c
	-$(RM) package/cfg/SlaveController_pem4f.xdc.inc

clean,em4f::
	-$(RM) SlaveController.pem4f
.executables,em4f .executables: SlaveController.xem4f

SlaveController.xem4f: |SlaveController.pem4f

-include package/cfg/SlaveController.xem4f.mak
SlaveController.xem4f: package/cfg/SlaveController_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/SlaveController_pem4f.oem4f   package/cfg/SlaveController_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
SlaveController.xem4f: export C_DIR=
SlaveController.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
SlaveController.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

SlaveController.test test,em4f test: SlaveController.xem4f.test

SlaveController.xem4f.test:: SlaveController.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 SlaveController.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.SlaveController.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,SlaveController.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) SlaveController.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
SlaveController_pem4f.oem4f,copy : package/cfg/SlaveController_pem4f.oem4f
SlaveController_pem4f.sem4f,copy : package/cfg/SlaveController_pem4f.sem4f
