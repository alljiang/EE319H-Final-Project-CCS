...
build-1884147009:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1884147009-inproc

build-1884147009-inproc: ../bigtime.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1884147009 ../bigtime.cfg
configPkg/compiler.opt: build-1884147009
configPkg/: build-1884147009
