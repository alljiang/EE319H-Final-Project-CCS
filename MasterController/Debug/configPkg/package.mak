...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccs930/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS
...
.dlls,em4f .dlls: MasterController.pem4f

-include package/cfg/MasterController_pem4f.mak
-include package/cfg/MasterController_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/MasterController_pem4f.dep
endif
MasterController.pem4f: package/cfg/MasterController_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
MasterController.pem4f package/cfg/MasterController_pem4f.c: .libraries,em4f
endif

package/cfg/MasterController_pem4f.c package/cfg/MasterController_pem4f.h package/cfg/MasterController_pem4f.xdl: override _PROG_NAME := MasterController.xem4f
package/cfg/MasterController_pem4f.c: package/cfg/MasterController_pem4f.cfg
package/cfg/MasterController_pem4f.xdc.inc: package/cfg/MasterController_pem4f.xdl
package/cfg/MasterController_pem4f.xdl package/cfg/MasterController_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/MasterController_pem4f.cfg
	-$(RM) package/cfg/MasterController_pem4f.dep
	-$(RM) package/cfg/MasterController_pem4f.c
	-$(RM) package/cfg/MasterController_pem4f.xdc.inc

clean,em4f::
	-$(RM) MasterController.pem4f
.executables,em4f .executables: MasterController.xem4f

MasterController.xem4f: |MasterController.pem4f

-include package/cfg/MasterController.xem4f.mak
MasterController.xem4f: package/cfg/MasterController_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/MasterController_pem4f.oem4f   package/cfg/MasterController_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
MasterController.xem4f: export C_DIR=
MasterController.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
MasterController.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

MasterController.test test,em4f test: MasterController.xem4f.test

MasterController.xem4f.test:: MasterController.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 MasterController.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.MasterController.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,MasterController.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) MasterController.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
MasterController_pem4f.oem4f,copy : package/cfg/MasterController_pem4f.oem4f
MasterController_pem4f.sem4f,copy : package/cfg/MasterController_pem4f.sem4f
